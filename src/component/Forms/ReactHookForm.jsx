...
//             console.log("Login successful", result); // Debugging log
//             alert("User logged in successfully");
//         } catch (error) {
//             console.error("Login failed:", error);
//             alert(error); // Display error for testing
//         }
//     };
...
//                     })}
//                 />
//                 {errors.password && <p className="text-danger text-small">{errors.password.message}</p>}
